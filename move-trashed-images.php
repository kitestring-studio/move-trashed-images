...
require_once "WP_Media_Trash_Command.php";
...
function register_wp_media_trash_command() {
    WP_CLI::add_command( 'media trash', 'WP_Media_Trash_Command' );
}
add_action( 'cli_init', 'register_wp_media_trash_command' );
